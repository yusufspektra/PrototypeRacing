...
{
	public partial struct ObscuredDouble : IFormattable, IEquatable<ObscuredDouble>, IEquatable<double>, IComparable<ObscuredDouble>, IComparable<double>, IComparable
	{
